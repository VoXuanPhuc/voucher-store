...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().totalCost(DEFAULT_TOTAL_COST).paymentTime(DEFAULT_PAYMENT_TIME);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().totalCost(UPDATED_TOTAL_COST).paymentTime(UPDATED_PAYMENT_TIME);
        return order;
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.totalCost(UPDATED_TOTAL_COST).paymentTime(UPDATED_PAYMENT_TIME);
        ...
        assertThat(testOrder.getPaymentTime()).isEqualTo(UPDATED_PAYMENT_TIME);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.totalCost(UPDATED_TOTAL_COST);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.totalCost(UPDATED_TOTAL_COST).paymentTime(UPDATED_PAYMENT_TIME);
