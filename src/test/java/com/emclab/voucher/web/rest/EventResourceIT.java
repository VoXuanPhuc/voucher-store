...
class EventResourceIT {
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return event;
    }
    ...
    void putNewEvent() throws Exception {
        ...
        updatedEvent.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
