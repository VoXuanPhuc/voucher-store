...
import com.emclab.voucher.repository.ProductRepository;
import com.emclab.voucher.service.dto.ProductDTO;
import com.emclab.voucher.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().code(DEFAULT_CODE).image(DEFAULT_IMAGE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().code(UPDATED_CODE).image(UPDATED_IMAGE);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.code(UPDATED_CODE).image(UPDATED_IMAGE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.code(UPDATED_CODE).image(UPDATED_IMAGE);
