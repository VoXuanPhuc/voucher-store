...
class StoreResourceIT {
    ...
    private static final String DEFAULT_AVARTAR = "AAAAAAAAAA";
    private static final String UPDATED_AVARTAR = "BBBBBBBBBB";
    ...
    void createStore() throws Exception {
        ...
        assertThat(testStore.getAvartar()).isEqualTo(DEFAULT_AVARTAR);
        assertThat(testStore.getBackground()).isEqualTo(DEFAULT_BACKGROUND);
    }
    ...
    void getAllStores() throws Exception {
        ...
        restStoreMockMvc
            ...
            .andExpect(jsonPath("$.[*].avartar").value(hasItem(DEFAULT_AVARTAR)))
            .andExpect(jsonPath("$.[*].background").value(hasItem(DEFAULT_BACKGROUND)));
    }
    ...
    void getStore() throws Exception {
        ...
        restStoreMockMvc
            ...
            .andExpect(jsonPath("$.avartar").value(DEFAULT_AVARTAR))
            .andExpect(jsonPath("$.background").value(DEFAULT_BACKGROUND));
    }
    ...
    void putNewStore() throws Exception {
        ...
        assertThat(testStore.getAvartar()).isEqualTo(UPDATED_AVARTAR);
        assertThat(testStore.getBackground()).isEqualTo(UPDATED_BACKGROUND);
    }
    ...
    void partialUpdateStoreWithPatch() throws Exception {
        ...
        partialUpdatedStore.description(UPDATED_DESCRIPTION).background(UPDATED_BACKGROUND);
