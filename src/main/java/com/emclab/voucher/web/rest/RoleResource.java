...
/**
 * REST controller for managing {@link com.emclab.voucher.domain.Role}.
 */
@RestController
@RequestMapping("/api")
public class RoleResource {
     ...
     */
    @GetMapping("/roles")
    public List<RoleDTO> getAllRoles(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
