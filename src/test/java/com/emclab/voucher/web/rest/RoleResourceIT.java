...
class RoleResourceIT {
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role().name(DEFAULT_NAME).code(DEFAULT_CODE);
        return role;
    }
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role().name(UPDATED_NAME).code(UPDATED_CODE);
        return role;
    }
    ...
    void putNewRole() throws Exception {
        ...
        updatedRole.name(UPDATED_NAME).code(UPDATED_CODE);
    ...
    void partialUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.code(UPDATED_CODE);
    ...
    void fullUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.name(UPDATED_NAME).code(UPDATED_CODE);
