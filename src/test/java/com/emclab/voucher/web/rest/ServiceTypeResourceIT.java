...
class ServiceTypeResourceIT {
    ...
    public static ServiceType createEntity(EntityManager em) {
        ServiceType serviceType = new ServiceType().name(DEFAULT_NAME).icon(DEFAULT_ICON);
        return serviceType;
    }
    ...
    public static ServiceType createUpdatedEntity(EntityManager em) {
        ServiceType serviceType = new ServiceType().name(UPDATED_NAME).icon(UPDATED_ICON);
        return serviceType;
    }
    ...
    void createServiceType() throws Exception {
        ...
        assertThat(testServiceType.getIcon()).isEqualTo(DEFAULT_ICON);
    }
    ...
    void putNewServiceType() throws Exception {
        ...
        updatedServiceType.name(UPDATED_NAME).icon(UPDATED_ICON);
        ...
        assertThat(testServiceType.getIcon()).isEqualTo(UPDATED_ICON);
    }
    ...
    void partialUpdateServiceTypeWithPatch() throws Exception {
        ...
        partialUpdatedServiceType.icon(UPDATED_ICON);
    ...
    void fullUpdateServiceTypeWithPatch() throws Exception {
        ...
        partialUpdatedServiceType.name(UPDATED_NAME).icon(UPDATED_ICON);
