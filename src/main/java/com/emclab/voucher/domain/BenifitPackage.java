...
public class BenifitPackage extends AbstractAuditingEntity {
    ...
    public BenifitPackage addStore(Store store) {
        ...
        store.setBenifit(this);
        return this;
    }

    public BenifitPackage removeStore(Store store) {
        this.stores.remove(store);
        store.setBenifit(null);
        return this;
    }

    public void setStores(Set<Store> stores) {
        if (this.stores != null) {
            this.stores.forEach(i -> i.setBenifit(null));
        }
        if (stores != null) {
            stores.forEach(i -> i.setBenifit(this));
        }
        this.stores = stores;
    }
