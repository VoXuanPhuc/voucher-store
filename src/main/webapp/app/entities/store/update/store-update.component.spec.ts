  ...
  describe('Store Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      ...
      it('Should call BenifitPackage query and add missing value', () => {
        const store: IStore = { id: 456 };
        const benifit: IBenifitPackage = { id: 66827 };
        store.benifit = benifit;
        ...
        const additionalBenifitPackages = [benifit];
      ...
      it('Should update editForm', () => {
        ...
        store.address = address;
        const benifit: IBenifitPackage = { id: 57461 };
        store.benifit = benifit;
        ...
        expect(comp.benifitPackagesSharedCollection).toContain(benifit);
      });
    });
