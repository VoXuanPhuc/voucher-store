...
public class Store implements Serializable {
    ...
    public BenifitPackage getPack() {
        return this.pack;
    }

    public Store pack(BenifitPackage benifitPackage) {
        this.setPack(benifitPackage);
        return this;
    }

    public void setPack(BenifitPackage benifitPackage) {
        this.pack = benifitPackage;
    }
